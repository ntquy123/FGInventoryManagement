...
namespace entities.Common
{
    ...
    {
        public DataFieldAutoValueType AutoType { get; set; } = DataFieldAutoValueType.Value;
            ...
            Func<object, object> preGenValue, Func<object, bool> preCheckAllowAutoValue)
        {
            ...
            if (fixValue == null && preGenValue == null)
                AutoType = DataFieldAutoValueType.DateTimeNow;
            else if (fixValue != null)
                AutoType = DataFieldAutoValueType.Value;
            else
                AutoType = DataFieldAutoValueType.FuncValue;
        }
